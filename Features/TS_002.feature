Feature: gift cards
  ...
  Scenario: verification of invalid inputs
    ...
    And the user enters the valid values (Reciepient name: "Saran",Senders name: "Saro")
    And the user enters the valid values (Reciepient number : "9876543210", sender number: "6382907857")
    And the user entersb the invalid mail Ids(sender mail id: "Saro1452@gmail/com" ,reciever mail id: "Saran2421@gmail.com")
